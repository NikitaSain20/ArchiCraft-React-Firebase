...
export default function ManageCustomers() {
  ...
  const handleBlockUser = async (userId) => {
    let confirm = window.confirm("Are sure you want to block the user?");
    if (confirm) {
      setLoad(true);
      try {
        ...
        toast.error("User Blocked Sucessfully", {
          position: "top-center",
        });
        setLoad(false);
  ...
  const handleActiveUser = async (userId) => {
    let confirm = window.confirm("Are sure you want to unblock the user?");
    if (confirm) {
      setLoad(true);
      try {
        const userDoc = doc(db, "users", userId);
        ...
        <div className="container-xxl py-5">
          <div className="container">
            ...
            >
              ...
              <h1 className="display-5 mb-4">Manage Customers</h1>
            </div>
