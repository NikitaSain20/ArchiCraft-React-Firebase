        ...
        onSnapshot(propertyTypesRef, (propertyTypeSnapshot) => {
          ...
          onSnapshot(usersRef, (userSnapshot) => {
            ...
            const joinedData = orders.map((order) => {
              ...
              const user = users.find((usr) => usr.uid === order.userId);
              return {
                ...order,
                propertyTypeData,
                user,
            ...
            const rejectedOrders = joinedData.filter(
              (order) => order.status === "Rejected"
            );
            setData(rejectedOrders);
          });
        });
      });
        ...
        <div className="container-xxl py-5">
          <div className="container">
            ...
            >
              ...
              <h1 className="display-5 mb-4">Rejected Orders</h1>
            </div>
